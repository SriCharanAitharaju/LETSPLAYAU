...
import { pgTable, text, varchar, index, timestamp, jsonb } from "drizzle-orm/pg-core";
...
// Users table (REQUIRED for Replit Auth - updated for email/profile)
export const users = pgTable("users", {
  ...
  passwordHash: varchar("password_hash"), // For email/password auth (optional)
  authMethod: varchar("auth_method").default("google"), // "google" or "password"
